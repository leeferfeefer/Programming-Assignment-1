...
public class RemoteBankUdp {
	...
	private static DatagramSocket currentSocket;
	...
	*/ 
	private static boolean amountTester(String amount) {
		...
		int amountStringLength = amount.length();
	...
	*	@param server_ip - Ip address of server for datagramsocket conenction
	...
	*/ 
	private static void createSocket(String server_ip, int port_number){
		...
		try {
			...
			ip_address = InetAddress.getByName(server_ip);
			...
			authenticateUser(port_number, ip_address, currentSocket);

			while (keepListening) {
				//Get message from server
				getMessage(currentSocket, ip_address, port_number);
			}
	...
	*	@param currentSocket - the current datagramsocket of the client
	*/ 
	private static void authenticateUser(int port_number, InetAddress ip_address, DatagramSocket currentSocket){
		if (isDebugMode) {
			System.out.println("Authenticating user...\n");
		}

		//Send "authentication request" message to server
		protocol.authRequest(port_number, ip_address, currentSocket);
	}
	...
	*	@param port_number - port number of server for datagramsocket connection
	*/ 
	private static void getMessage(DatagramSocket currentSocket, InetAddress ip_address, int port_number) {
		if (isDebugMode) {
			System.out.println("/--------------------------\\");
		...
		protocol.readServerMessage(currentSocket, ip_address, port_number);
	}
	...
	*/  
	...
	/*
		User info getters - this data is gathered from input in terminal
	*/
